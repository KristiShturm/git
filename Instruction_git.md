...
Чтобы вывести все изменения в графическом виде используют команду:

    git log --graph

_*можно объединить все команды вместе, тогда мы увидим все изменения во всех ветках построчно и в графическом виде:
